...
// Strict Boolean: True for "true"/"yes"/"1"/"done", False for EVERYTHING else
...
function main() {
    ...
    for (let i = 1; i < rawLines.length; i++) {
        ...
        // Stop if folder number exceeds 4848
        if (folderIdx !== -1) {
    ...
    console.log(`\n🎉 SUCCESS! Cleaned ${count} rows (capped at 4848).`);
