          ...
          <table className="w-full border-collapse border border-black text-[12px]">
            <thead>
              <tr className="bg-gray-50/70">
                ...
                <th className="border border-black px-3 py-1.5 text-left font-bold w-[35%]">
                  Make
                </th>
                <th className="border border-black px-3 py-1.5 text-left font-bold w-[25%]">
                  Quantity
                </th>
              </tr>
            </thead>
            <tbody>
              ...
              <tr>
                ...
                <td className="border border-black px-3 py-1.5 text-gray-800">
                  <HighlightWrapper
                    isChanged={isFieldChanged('page2.solarPanelMake')}
                    active={highlightChanges}
                    fieldLabel="Solar Panel Make"
                    onClick={() => onEditField?.('page2.solarPanelMake')}
                  >
                    <span>{page2.solarPanelMake || 'Waree 580'}</span>
                  </HighlightWrapper>
                </td>
                <td className="border border-black px-3 py-1.5 text-gray-800">
                  <HighlightWrapper
                    isChanged={isFieldChanged('page2.solarPanelQty')}
                    active={highlightChanges}
                    fieldLabel="Solar Panel Quantity"
                    onClick={() => onEditField?.('page2.solarPanelQty')}
                  >
                    <span>{page2.solarPanelQty}</span>
                  </HighlightWrapper>
                </td>
              </tr>

              {/* Row 2: Inverter (Merged Make & Quantity - line removed) */}
              <tr>
                <td className="border border-black px-3 py-1.5 font-bold text-gray-900">
                  Inverter
                </td>
                <td colSpan={2} className="border border-black px-3 py-1.5 text-gray-800 font-medium">
                  <HighlightWrapper
