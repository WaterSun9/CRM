export interface AssetImages {
  watersunLogoUrl?: string; // Screenshot 1: Watersun Logo
  screenshot2MiddleBannerUrl?: string; // Screenshot 2: Full Page 1 Middle Block (GEDA + MNRE + Modi Banner)
  gedaLogoUrl?: string;
  mnreLogoUrl?: string;
  suryaGharBannerUrl?: string;
  tataSolaroofLogoUrl?: string; // Screenshot 3: Tata Power Solaroof Logo
}

export interface BrandQuoteOption {
  brandName: string; // e.g., "Waaree Solar", "Tata Power Solar", "Adani Solar"
