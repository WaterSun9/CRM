import { QuotationData, InverterPreset } from '../types';
...
export const INITIAL_QUOTATION: QuotationData = {
  ...
  page1: {
    customerName: 'DARAJI CHANDUBHAI PARSOTTAMBHAI',
    customerPhone: '8200774492',
    quotationNo: 'Quote-3255',
    date: '05-09-2026',
    capacityKw: '3.48 kw',
    yoursTrulyName: 'Mr. Watersun office',
    yoursTrulyPhone: '+91 70165 89864',
    introParagraph1:
  ...
  page2: {
    solarPanelMake: 'Waree 580',
    solarPanelQty: '6',
    inverterOption: 'Option 1',
    inverterBrand: 'Solaryan',
    ...
    brandOptions: [
      {
        ...
        baseValue: 189000,
        discount: 0,
        netPayableAmount: 189000,
        subsidy: 78000,
        netPriceAfterSubsidy: 111000,
      },
      {
