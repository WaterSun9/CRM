                        ...
                        <div className="flex flex-col gap-2">
                            {editData.payment_type?.trim().toLowerCase() !== 'cash' && (
                                <>
                                    ...
                                    <CheckboxRemarkItem label="Index 2" field="index_2" value={editData.index_2} onChange={handleChange} isEditing={isEditable} documents={documents} onUpload={onFileUpload} onDelete={onDeleteDocument} onPreview={onViewDocument} onUpdateRemark={onUpdateRemark} />
                                </>
                            )}
