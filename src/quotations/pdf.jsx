...
import DocumentPages, { fitQuotationPages } from './DocumentPages';
...
export async function generateQuotationPdf(row) {
    ...
    host.style.cssText = 'position:fixed;left:-12000px;top:0;width:794px;background:white;pointer-events:none;';
    ...
    try {
        ...
        for (let i = 0; i < pages.length; i++) {
            const canvas = await html2canvas(pages[i],{ scale:1.7,backgroundColor:'#ffffff',logging:false,useCORS:true,windowWidth:1280,windowHeight:1400 });
