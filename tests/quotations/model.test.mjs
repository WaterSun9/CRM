...
const user = {id:'11111111-1111-4111-8111-111111111111',name:'Test agent',phone:'9876543210',userType:'agent'};
function complete() {
    return {...newForm(user),customer_name:'Test customer',customer_phone:'9876543211',capacity_kw:3.48,solar_panel_make:'Waaree',solar_panel_qty:6,panel_wattage:580,inverter_option:'Option 1',inverter_brand:'Solaryan',options:['Waaree','Tata','Adani'].map(brandName => ({brandName,baseValue:189000,discount:1000,subsidy:78000}))};
}
...
test('deferred quotation-to-lead mapping remains ready for later activation',() => {
    ...
    assert.equal(lead.phone_number,'9876543211');
    assert.equal(lead.system_capacity_kwp,3.48);
    assert.equal(lead.module_brand,'Waaree');
